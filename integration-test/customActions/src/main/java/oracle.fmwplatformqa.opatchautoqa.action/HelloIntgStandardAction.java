...
@ActionImpl(name = HelloIntgStandardAction.ACTION_NAME)
public class HelloIntgStandardAction extends AbstractWLSTActionImpl {
    public static final String ACTION_NAME = "helloworld.sayHello";
    private static final String SCRIPT_AND_METHOD = "helloworld.sayHello";
