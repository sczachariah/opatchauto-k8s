...
@ActionImpl(name = ZdtCustActionHello.ACTION_NAME)
public class ZdtCustActionHello extends AbstractWLSTActionImpl {
    public static final String ACTION_NAME = "opatchautozdtqa_customactions.sayHello";
    private static final String SCRIPT_AND_METHOD = "opatchautozdtqa_customactions.sayHello";
