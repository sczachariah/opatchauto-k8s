...
@ActionImpl(name = CustomActionHowAreYou.ACTION_NAME)
public class CustomActionHowAreYou extends AbstractWLSTActionImpl {
    public static final String ACTION_NAME = "opatchautofmwqa_customactions.sayHowAreYou";
    private static final String SCRIPT_AND_METHOD = "opatchautofmwqa_customactions.sayHowAreYou";
