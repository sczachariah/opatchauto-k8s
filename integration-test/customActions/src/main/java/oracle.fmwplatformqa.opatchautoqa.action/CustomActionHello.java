...
@ActionImpl(name = CustomActionHello.ACTION_NAME)
public class CustomActionHello extends AbstractWLSTActionImpl {
    public static final String ACTION_NAME = "opatchautofmwqa_customactions.sayHello";
    private static final String SCRIPT_AND_METHOD = "opatchautofmwqa_customactions.sayHello";
